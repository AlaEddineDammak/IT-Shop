...
<body>
  ...
  $stmt = $conn->prepare("INSERT INTO flower2 (designation, categorie, quantite_en_stock, prix_unitaire, promo) VALUES (?, ?, ?, ?, ?)");
  ...
  foreach ($produits as $produit) {
    ...
    $stmt->bind_param("ssids", $designation, $categorie, $quantite_en_stock, $prix_unitaire, $promo);
